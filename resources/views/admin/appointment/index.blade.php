  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('appointment_list') }}" method="GET">
          <div class="row">
            
            <div class="col col-md-2">
              <div class="form-group">
                <input type="text" class="form-control" id="selector" name="app_date" value="{{request("app_date")}}" placeholder="choose date">
              </div>
            </div>
            ...
            <div class="col col-md-2">
              <a href="{{ route("appointment_export", ["app_date"=>request("app_date"), "app_cat_id"=>request("app_cat_id"), "company_registration_no"=>request("company_registration_no")]) }}" class="btn btn-info">Export File</a>
            </div>
          </form>
        </div>
        <!-- /.d-flex -->
            ...
            <div class="table-responsive">
              <table id="order-listing" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ $index + 1}}</td>
                    <td>{{ Carbon\Carbon::parse($appList->appointment_date)->format('d-M-Y / D') }}</td>
